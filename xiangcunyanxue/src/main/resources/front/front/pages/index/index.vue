...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;" :style='{"backgroundColor":"var(--publicSubColor)","borderColor":"var(--publicMainColor)","color":"rgba(255, 255, 255, 1.0)","borderRadius":"30rpx 30rpx 0px 0px","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"solid  solid none solid"}'>
    ...
    <view class="right-content" @tap="onPageTap('jingdian')" :style="{fontSize:'32rpx',color:'rgba(255, 255, 255, 1.0)'}">
        查看更多
    </view>
</view>
<view class="list-box style1"
    ...
    <view @tap="onDetailTap('jingdian',product.id)" v-for="(product,index) in jingdianList" :key="index"
          class="list-item"
        ...
        <view
                ...
                class="list-item-title hide1">{{product.jingdianName}}
        </view>
        <image
                ...
                :src="baseUrl+product.jingdianPhoto"></image>
    </view>
</view>
        </view>
        <view class="listBox recommend">
...
<view class="list-box style1"
      :style='{"padding":"40rpx 24rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
    <view @tap="onDetailTap('shangpin',product.id)" v-for="(product,index) in shangpinList" :key="index"
          class="list-item"
          :style='{"padding":"0","boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 0 20rpx","borderColor":"rgba(0,0,0,0)","backgroundColor":"var(--publicSubColor)","borderRadius":"20rpx","borderWidth":"0","width":"48%","borderStyle":"solid","height":"auto"}'>
        <view
                :style='{"padding":"0 20rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"#333","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","borderStyle":"solid"}'
                class="list-item-title hide1">{{product.shangpinName}}
        </view>
        <image
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 auto -10rpx","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"300rpx"}'
                class="list-item-image" mode="aspectFill"
...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;" :style='{"backgroundColor":"var(--publicSubColor)","borderColor":"var(--publicMainColor)","color":"rgba(255, 255, 255, 1.0)","borderRadius":"30rpx 30rpx 0px 0px","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"solid  solid none solid"}'>
    ...
    <view class="right-content" @tap="onPageTap('yanxue')" :style="{fontSize:'32rpx',color:'rgba(255, 255, 255, 1.0)'}">
        查看更多
    </view>
</view>
<view class="list-box style1"
      :style='{"padding":"40rpx 24rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
    <view @tap="onDetailTap('yanxue',product.id)" v-for="(product,index) in yanxueList" :key="index"
          class="list-item"
          :style='{"padding":"0","boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 0 20rpx","borderColor":"rgba(0,0,0,0)","backgroundColor":"var(--publicSubColor)","borderRadius":"20rpx","borderWidth":"0","width":"48%","borderStyle":"solid","height":"auto"}'>
        <view
                :style='{"padding":"0 20rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"#333","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","borderStyle":"solid"}'
                class="list-item-title hide1">{{product.yanxueName}}
        </view>
        <image
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 auto -10rpx","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"300rpx"}'
                class="list-item-image" mode="aspectFill"
                :src="baseUrl+product.yanxuePhoto"></image>
    </view>
</view>
        </view>
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            let jingdian = await this.$api.requestCondition('jingdian','gexingtuijian',jingdianVal);

            this.jingdianList = jingdian.data.list
            this.jingdianList.forEach(function(item, index) {
            ...
            let yanxue = await this.$api.requestCondition('yanxue','gexingtuijian',yanxueVal);

            this.yanxueList = yanxue.data.list
            this.yanxueList.forEach(function(item, index) {
